  ...
  return (
    <main className="landing">
      ...
      <section className="landing-hero">
        ...
        <h1 className={korean ? undefined : "japanese-headline"}>{korean ? <>모두의<br /><strong>“언제·어디서·몇 시에 출발할지”</strong><br />한곳에.</> : <><span>みんなの</span><strong><span>「いつ・どこ・</span><span>何時に出る？」</span></strong><span>を、ひとつに。</span></>}</h1>
