type AimashoIconName = "calendar" | "history" | "friend" | "group" | "user" | "sun" | "map" | "sparkles";
...
export function AimashoIcon({ name, className = "" }: { name: AimashoIconName; className?: string }) {
  ...
  return <svg className={`aimasho-icon ${className}`.trim()} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    {name === "sparkles" ? <g {...common}><path d="m10 3 2.4 6.6L19 12l-6.6 2.4L10 21l-2.4-6.6L1 12l6.6-2.4zM19 2v6M16 5h6" /></g> : null}
    ...
    {name === "map" ? <g {...common}><path d="m3.5 6 5-2.5 7 2.5 5-2.5v14.5l-5 2.5-7-2.5-5 2.5z" /><path d="M8.5 3.5v14.5M15.5 6v14.5" /><path d="M11 9.5c1.8-1.4 3.3-1.4 4.5 0" /></g> : null}
  </svg>;
}
